...
outcome_upload = processing_docs.upload_documents(config['qdrant']['collection'], client_vdb, embeddings, text, id=1)  ## INSERT ID GETTING DIRECTLY TO API CALL 
...
prompt = "How can I discover and extract the possible violation?"
